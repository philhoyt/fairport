...
<div class="wp-block-cover alignfull" style="min-height:420px"><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( $fairport_image ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-secondary-background-color has-background-dim-60 has-background-dim"></span><div class="wp-block-cover__inner-container">
